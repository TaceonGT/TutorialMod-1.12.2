...
import com.ridebuilder5.tutorialmod.items.ItemBase;
import com.ridebuilder5.tutorialmod.items.armor.ArmorBase;
import com.ridebuilder5.tutorialmod.items.food.FoodBase;
import com.ridebuilder5.tutorialmod.items.food.FoodEffectBase;
import com.ridebuilder5.tutorialmod.items.tools.ToolAxe;
import com.ridebuilder5.tutorialmod.items.tools.ToolHoe;
import com.ridebuilder5.tutorialmod.items.tools.ToolPickaxe;
import com.ridebuilder5.tutorialmod.items.tools.ToolSpade;
import com.ridebuilder5.tutorialmod.items.tools.ToolSword;
...
public class ModItems {
	...
	//Food Effects (name, amount, saturation, isAnimalFood, potion, duration, strength (i.e. 1, 2, etc), ambient, particles)
